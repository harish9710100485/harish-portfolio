      ...
      <div className="container-custom">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="mt-4">
              Junior Software Developer with hands-on experience working on projects like Capex Raising System, 
        ...
        <div className="mt-12 text-center">
          <Card className="inline-block w-full max-w-md">
            <CardContent className="p-6 text-center">
              ...
              <a 
                href="https://drive.google.com/file/d/15Lulgp5pwdUV8wS70D2Mkxu-w-ofQwSi/view?usp=drive_link" 
                target="_blank"
