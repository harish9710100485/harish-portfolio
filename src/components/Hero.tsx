          ...
          <div className="order-2 md:order-1">
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <Button className="btn-primary animate-fadeInUp animate-delay-400" asChild>
                <a href="https://drive.google.com/file/d/1NyoNYtySrFT2NdLYKNlznZrfowREFg1t/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
                  Download Resume
                </a>
              </Button>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/harish9710100485" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile" className="animate-fadeInUp animate-delay-600">
                <Button variant="ghost" size="icon">
                  <Github className="h-5 w-5" />
                </Button>
              </a>
              <a href="https://www.linkedin.com/in/harish-perumal-5a4461270/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile" className="animate-fadeInUp animate-delay-700">
                <Button variant="ghost" size="icon">
                  <Linkedin className="h-5 w-5" />
                </Button>
              </a>
              <a href="https://wa.me/919710100485" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="animate-fadeInUp animate-delay-800">
                <Button variant="ghost" size="icon">
